...
<body>
    <div class="card">
        <img src="assets/dumbell.gif" alt="Sports Icon" class="sports-image mx-auto">
        <h2 class="welcome-text text-4xl font-bold mb-8">Welcome to SMARTFIT</h2>
        <p class="text-gray-600 mb-6">Join the ultimate sports community! Track your exercise and level up more and more!!</p>
