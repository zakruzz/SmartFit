...
const char* ei_classifier_inferencing_categories[] = { "idle", "pushup", "situp", "squatjump" };
...
const ei_impulse_t impulse_691599_0 = {
    .project_id = 691599,
    .project_owner = "Lintang Kosesar",
    .project_name = "ragasehat",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 1,

    .nn_input_frame_size = 207,
    .raw_sample_count = 106,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 106 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 18.867924528301888,
    .frequency = 53,
...
ei_impulse_handle_t impulse_handle_691599_0 = ei_impulse_handle_t( &impulse_691599_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_691599_0;
